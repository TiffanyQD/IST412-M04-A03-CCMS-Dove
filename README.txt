...
<p>
In this week's exercise, the Civilian Use Case was developed.  To test the modules, enter '11111' for valid input.
If 'aaaaa; is entered, an error message will be displayed.
</p>
