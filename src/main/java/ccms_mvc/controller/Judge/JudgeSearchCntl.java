...
public class JudgeSearchCntl implements ActionListener {
    ...
    public JudgeSearchCntl() {
        ...
        //set the JudgeSearchUI to be visible (true)
    ...
    public void actionPerformed(ActionEvent e) {
        ...
        if (obj.equals(judgeSearchUI.btnSearch)) {
            ...
            if (caseNumberFound) {
                judgeSearchUI.clearTheFieldsInCourtCasesUI();
                judgeSearchUI.parseCourtCases(courtCases);
                judgeSearchUI.setIndexOfCurrentCourtCase(indexOfCurrentCourtCase);
